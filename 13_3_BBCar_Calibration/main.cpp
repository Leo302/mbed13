...
int main() {
    ...
    double pwm_table0[] = { 0, 30, 60, 90, 120, 150};

    double speed_table0[] = {0.000,6.619,12.441,15.551,16.827,17.226};

    double pwm_table1[] = { 0, 30, 60, 90, 120, 150};

    double speed_table1[] = {0.080,5.503,11.563,14.993,16.269,16.827};
